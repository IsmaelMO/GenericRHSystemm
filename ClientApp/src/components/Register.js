                        ...
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                <div className='modal-containter'>
                                    <form name='formData' onSubmit={this.validateFormModal}  >
                                        <div className='row'>
                                            <div className='col-12 mb-2 pl-5 pr-5'>
                                                <label className='lbl-form col-12 font-weight-bold'>Usuario</label>
                                                <input className='input-modal col-12' type="text" name="user" onChange={this.handleChange} required />
                                            </div>
                                            <div className='col-12 mb-2 pl-5 pr-5'>
                                            ...
                                            <div className='col-12 mb-2 pl-5 pr-5'>
                                                ...
                                                <input className='input-modal col-12' type="text" name="password" onChange={this.handleChange} required />
                                            </div>
                                            ...
                                            <div className='col-12 mb-3 pl-5 pr-5'>
                                                <label className='lbl-form col-12'>Fecha de creación: {date + "/" + month + "/" + year}</label>
                                                <input className='input-modal col-12' type="text" name="creationdate" onChange={this.handleChange} hidden />
                                            </div>
